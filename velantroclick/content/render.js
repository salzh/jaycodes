        ...
        .ns(function()
        {
	        with (noojeeClick.LIB)
	        {
		        ...
		        theApp.render =
		        {
		            ...
		            njClickElementName : "VelantroClickImg",
		            ...
		            onRefreshOne : function(doc)
		            {
			            ...
			            try
			            {
				            ...
				            var spans = doc.getElementsByName("VelantroClick");
				            theApp.logging.njdebug("remove", "VelantroClick spans=" + spans);
				            ...
				            else
				            {
					            ...
					            if (pattern != null && theApp.util.trim(pattern).length != 0)
					            {
						            ...
						            for ( var candidateTag = null, i = 0; (candidateTag = candidateTags.snapshotItem(i)); i++)
						            {
                                        ...
                                        if (candidateTag.offsetParent === null) continue;
                                        if (candidateTag.nodeValue.length < 7) continue;
                                        if (!twodig.test(candidateTag.nodeValue)) continue;
							            ...
							            if (phonePatternRegex.test(candidateTag.nodeValue))
							            {
								            ...
								            if (candidateTag.parentNode != null
								                    && candidateTag.parentNode.getAttribute("name") != "VelantroClick")
								            {
									            ...
									            for ( var match = null, lastLastIndex = 0; (match = phonePatternRegex.exec(candidateContents));)
									            {
										            ...
										            else if (renderStyle == "button")
										            {
											            ...
											            clickElement.setAttribute("name", "VelantroClick");
											            clickElementid = "VelantroClick-click";
